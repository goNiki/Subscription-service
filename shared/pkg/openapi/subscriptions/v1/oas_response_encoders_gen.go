...
func encodeGetTotalCostSubscriptionsResponse(response GetTotalCostSubscriptionsRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *GetTotalcostResponse:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeSubscriptionDeleteByIDResponse(response SubscriptionDeleteByIDRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *SubscriptionDeleteByIDNoContent:
		w.WriteHeader(204)
...
func encodeSubscriptionUpdateByIDResponse(response SubscriptionUpdateByIDRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *SubscriptionsRespDto:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
